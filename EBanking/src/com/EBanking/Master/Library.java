...
public String AdminLogin(String UserName,String Password) throws InterruptedException
{
	Thread.sleep(2000);
...
public String BranchLogin(String BranchName,String BankerName,String BPassword) throws InterruptedException
{
	Thread.sleep(2000);
	new Select(driver.findElement(By.xpath(Pr.getProperty("BName")))).selectByVisibleText(BranchName);
	driver.findElement(By.id(Pr.getProperty("AUid"))).sendKeys(BankerName);
	driver.findElement(By.id(Pr.getProperty("APwd"))).sendKeys(BPassword);
	driver.findElement(By.id(Pr.getProperty("ALogin"))).click();
	ExpResult ="Welcome to Amberpet Branch ";
	ActResult=driver.findElement(By.xpath(Pr.getProperty("BText"))).getText();
	if(!ExpResult.equalsIgnoreCase(ActResult))
	{
		System.out.println("Banker Home Page Opened Successfully");
		return "Pass";
	}
	else
	{
		System.out.println("Banker Home Page not Opened");
		return "Fail";
	}
}
public void RBLogout()
{
	driver.findElement(By.xpath(Pr.getProperty("BLogout"))).click();
}
public void Logout()
{
